...
Template.ooImageCropperModal.onRendered(function() {
  ...
  img.onload = () => {
    ...
    if (img[longEdge] > 964) {
      ...
      ctx.transform(-1, 0, 0, 1, metrics.width, 0);
      ctx.transform(-1, 0, 0, -1, metrics.width, metrics.height );
      ctx.transform(1, 0, 0, -1, 0, metrics.height );
      ctx.transform(0, 1, 1, 0, 0, 0);
      ctx.transform(0, 1, -1, 0, metrics.height, 0);
      ctx.transform(0, -1, -1, 0, metrics.height, metrics.width);
      ctx.transform(0, -1, 1, 0, 0, metrics.width);
